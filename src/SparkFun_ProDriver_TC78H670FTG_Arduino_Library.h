...
#define QWIIC_TWIST_ADDR 0x73 //7-bit unshifted default I2C Address
...
enum encoderRegisters
{
  ...
  TWIST_COUNT1 = 0x05,
  TWIST_DIFFERENCE1 = 0x07,
  TWIST_COUNT2 = 0x09,
  TWIST_DIFFERENCE2 = 0x0B,  
  TWIST_LAST_ENCODER_EVENT = 0x0D, //Millis since last movement of knob

  TWIST_TURN_INT_TIMEOUT = 0x0F,
  TWIST_CHANGE_ADDRESS = 0x11,
  TWIST_LIMIT = 0x12,
};
...
public:
  ...
  int16_t getCount1();                                       //Returns the number of indents the user has turned the knob
  int16_t getCount2();                                       //Returns the number of indents the user has turned the knob  
  boolean setCount(int16_t amount);                          //Set the number of indents to a given amount
  int16_t getDiff1(boolean clearValue = true);               //Returns the number of ticks since last check
  int16_t getDiff2(boolean clearValue = true);               //Returns the number of ticks since last check  
